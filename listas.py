#son ejercicios para practicar listas 
'''
print("")
print("")
print("")
...
materias=["español","matematicas","quimica","fisica", "historia" ]
print("Ejercicio 1")
print()
...
notas=[]
for materia in materias:
    print("¿Cuanto sacaste en " + materia)
    nota = input()
    notas.append(nota)

for i in range(len(materias)):
    print("En "+materias[i]+ " obtuviste "+ notas[i])
'''i=0
for materia in materias:
    if i in range(len(notas))
    print("En "+ materia + "obtuviste "+ notas[i])'''
'''for i in range(len(materias)):
    print("en "+ i +" obtuviste la calificación " + i)
print()
print()'''
